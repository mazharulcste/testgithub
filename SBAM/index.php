...
<?php include("template/slider.php"); ?>
		...
		<div class="">
			<div class="container">
					...
					<div class="welcome-grids">
						...
						<div class="col-md-12 welcome-grid1">
							<h2 style="text-align:center;color:white;">Welcome to our page</h2>
							<h4 style="text-align:center;">Vestibulum interdum mi sit amet</h4>
							...
							<a href="#" class="button" style="margin-left:420px; margin-top:-100px;"> read more</a>
								<div class="welcomes-grids">
									<div class="col-md-4 welcomes-grid">
										<img src="images/w1.jpg" class="img-responsive" alt="" style="width:250px;">
									</div>
									<div class="col-md-4 welcomes-grid">
										<img src="images/w2.jpg" class="img-responsive" alt="" style="width:250px;">
									</div>
									<div class="col-md-4 welcomes-grid">
										<img src="images/w3.jpg" class="img-responsive" alt="" style="width:250px;">
									</div>
	...
	<!-- //slider -->
			<!--features-->
				<div class="feature" style="max-width:1100px;">
					<div class="container">
						<h3>features</h3>
		  ...
		  <div class="event-grids">
				<div class="col-md-4 event-grid">
					...
					<div class="event-grid_pic">
						<img src="images/e1.gif" class="img-responsive" alt=""/>
				...
				<div class="col-md-4 event-grid">
					...
					<div class="event-grid_pic">
						<img src="images/e2.gif" class="img-responsive" alt=""/>
						<h4><a href="#">Morbi pellentesque urna</a></h4>
						<p>Nullam placerat aliquet nisl id finibus. Nulla mollis mattis magna in hendrerit. Pellentesque nunc nisl, dapibus eget erat non,
						sagittis accumsan dolor.</p>
					</div>
