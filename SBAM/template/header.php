...
<body style="max-width:1100px;margin:auto;">
	...
	<div class="header">
	   ...
	   <div style="height:180px;background-color:white;">
		  <img src="images/logo3.png" class="img-fluid" alt="Responsive image" style="width:120px;float:left;">
	      <img src="images/southbangla3.png" class="img-fluid" alt="Responsive image" style=";width:500px;margin-top:121px;margin-left:-120px;">
	  	</div>
