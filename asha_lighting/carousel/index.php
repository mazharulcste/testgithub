...
$result=  mysql_query("SELECT * FROM tbl_image WHERE category='new_product'");
?>
...
<body style="font-family:Arial, Verdana;background-color:#fff;">
    ...
    <script>
        jssor_slider1_starter = function (containerId) {
            ...
            function ScaleSlider() {
                ...
                if (bodyWidth)
                    jssor_slider1.$ScaleWidth(Math.min(bodyWidth, 1209));
                else
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1200px; height: 270px; overflow: hidden; ">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1200px; height: 250px; overflow: hidden; padding:10px;">
<!--            <div style="padding:10px;margin-right:10px;"><img u="image" src="img/ancient-lady/005.jpg" /></div>-->
            <?php while($row=  mysql_fetch_array($result)){?>
            <div>
                
                <img u="image" src="../admin/<?php echo $row['image'];?>" />
