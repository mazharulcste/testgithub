...
if(isset($_POST['submit'])){
    ...
    $save=mysql_query("INSERT INTO tbl_page_article(header,text,category) VALUES ('$header','$text','$category')");
      
 }
//     $sql=mysql_query("SELECT * FROM tbl_japan ORDER BY japan_id DESC");
...
<html lang="en">
  <head>
    ...
    <title> Home Page Article Add  </title>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" name="category">
                                                    ...
                                                    <option value="c_m"> Company Mission  </option>
                                                    <option value="c_v"> Company Vision  </option>
                                                    <option value="c_o"> Company Objectives  </option>
                                                    <option value="c_va"> Company Values  </option>
