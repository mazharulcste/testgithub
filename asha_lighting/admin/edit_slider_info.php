...
$row = mysql_query("SELECT * FROM tbl_slider WHERE slider_id='$id'");
$result=mysql_fetch_array($row);
	...
	if ($file==""){
	//echo "";
         $save_1=mysql_query("UPDATE tbl_slider SET caption='$caption' where slider_id='$id'");
         if($save_1){
	...
	$image_name= addslashes($_FILES['image']['name']);
			...
			$save=mysql_query("UPDATE tbl_slider SET location='$location',caption='$caption' where slider_id='$id'");
			header("location:edit_slider.php");
			exit();					
	   }		
	}
                          ...
                          <div class="table-responsive">
                              <form action="" method="post" enctype="multipart/form-data">
                                  <table class="table table-bordered table-hover tablesorter">
									  ...
									  <tr>
										<td> Caption: </td>
										<td> <p align='center'> <input type="text" name="caption" class="form-control" value="<?php echo $result['caption'];?>" </p></td>
									  </tr>
                                      ...
                                      <tr>
                                          ...
                                          <td> 
                                              ...
                                              <a href="edit_slider.php" class="btn btn-danger"> Back </a>
                                          </td>
                                      </tr>
