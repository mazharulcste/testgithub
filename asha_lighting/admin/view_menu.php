  ...
  <head>
    ...
    <script src="//cdn.ckeditor.com/4.5.3/full/ckeditor.js"></script>
            ...
            function remove(id)
            {
                ...
                {
                        window.location='delete_menu.php?remove_id='+id;
                }
            }
        </script>
  </head>
...
<!--                                                <td> <?php echo $row['product_menu'];?>  </td>-->
                                                <td>
                                                    <a href="edit_menu.php?id=<?php echo $row['menu_id'];?>" class="btn btn-success"> Edit </a>
                                                    <a href="javascript:remove(<?php echo $row['menu_id'] ?>)" class="btn btn-danger"> Delete </a>
                                                </td>  
                                          </tr>
                                          <?php }?>
